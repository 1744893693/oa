...
class Test extends Login{
    ...
    function test_insert(){
        ...
        $p=$b[0]['name'];
        $v = $aa->sql_operation("insert into test (name,test_name,release_time,submission_time,test_content,department_id) VALUES  ('$name','$test_name','$release_time','$submission_time','$test_content','$p')");
